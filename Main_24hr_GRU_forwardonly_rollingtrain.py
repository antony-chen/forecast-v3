"""Train/evaluate the 24-hour autoregressive GRU with hourly rolling training and one forward encoder.
...
from Model_24hr_GRU_forwardonly_rollingtrain import VariationalSeq2Seq_meta
...
def run_experiment(
    ...
    if cfg.require_resume and resume_path is None:
        raise ValueError("ONCOR_REQUIRE_RESUME=1 but no GRU checkpoint was supplied")
    ...
    mc_names = {checkpoint_internal_names.get(name, name) for name in cfg.mc_checkpoint_names()}
...
# ============================================================
# Default experiment: hourly rolling 24h training + autoregressive GRU + forward-only encoder
# ============================================================
if __name__ == "__main__":
    run_experiment(
        encoder_mode="forward",
        run_name=(
            os.getenv("ONCOR_RUN_NAME", "24hr_gru_forwardonly_rollingtrain")
        ),
