...
DEFAULT_RUN_NAME = os.getenv("ONCOR_RUN_NAME", "24hr_mlp_forwardonly_rollingtrain")
...
def plot_month(records: List[Dict], month: int, out_path: Path, profile_name: str, checkpoint_name: str, global_ylim: Tuple[float, float] | None = None):
    ...
    for i, rec in enumerate(records):
        ...
        title = (
            f"24hr MLP Forward-Only Rolling-Train | Profile {profile_name} | "
    ...
    fig.suptitle(
        f"24hr MLP Forward-Only Rolling-Train | Profile {profile_name} | {TARGET_YEAR}-{month:02d} | "
